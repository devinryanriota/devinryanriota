...
- [Airy](https://www.crunchbase.com/organization/airy-rooms) - Started my career in a mid-stage hospitality startup, as a software engineer working on backend, frontend, and infrastructure.
- [Traveloka](https://www.traveloka.com) - Joined a well established organization with hundreds of engineers, handling some of their core services which receives thousands of requests per second. 
- [Cosmart](https://www.cosmart.id) - Joined a super early stage startup as the first engineer, built the initial MVP that helped raise $5M in seed funding, then leading and growing the engineering team to 15 people across different roles (backend, frontend mobile & web, quality assurance, and data analyst). 
